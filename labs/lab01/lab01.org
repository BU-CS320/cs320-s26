...
to resolve a merge conflict after doing this, but if you do, take a
look at the GitHub Docs instructions on [[https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/addressing-merge-conflicts][Addressing merge conflicts]] for
